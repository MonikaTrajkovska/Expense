 ...
 class Register extends React.Component {
     ...
     register = (event) => {
         if(this.state.first_name === null ||
             ...
             event.preventDefault()
             axios.post('http://mern-app-expensecalculator.herokuapp.com/api/v1/auth/register', {
             ...
             .then(res => {
                 console.log(res)
                 axios.post('http://mern-app-expensecalculator.herokuapp.com/api/v1/auth/login', {
                     email: this.state.email,
                     password: this.state.password
                 })
                 .then(res=>{
